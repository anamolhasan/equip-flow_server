-- CreateEnum
CREATE TYPE "EquipmentStatus" AS ENUM ('AVAILABLE', 'MAINTENANCE', 'DAMAGED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "EquipmentCondition" AS ENUM ('NEW', 'LIKE_NEW', 'GOOD', 'FAIR', 'POOR');

-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING_APPROVAL', 'AWAITING_PAYMENT', 'CONFIRMED', 'ACTIVE', 'RETURNED', 'REJECTED', 'CANCELLED');
...
-- AddForeignKey
ALTER TABLE "Equipment" ADD CONSTRAINT "Equipment_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_approvedByAdminId_fkey" FOREIGN KEY ("approvedByAdminId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
